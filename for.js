...
var sentence = "The weather this week is going through many states such as "
for (var i = 0; i < weather_options.length; i++) {
  if (i === weather_options.length - 1) {
    sentence += "and " + weather_options[i] + ".";
  } else {
    sentence += weather_options[i] + ", ";
  }
}
...
// 📹 Record yourself live-coding and talking through any ONE of the challenges. 
  ...
  // Share the link to your video in the Discord channel.
